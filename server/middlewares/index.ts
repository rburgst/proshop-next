...
export declare type MiddlewareFunction<REQ extends NextApiRequest = NextApiRequest, T = any> = (
  req: REQ,
...
const withMiddleware = (
  ...
  try {
    ...
    const middlewares = [logRequestMiddleware, ...aditionalMiddlewares].filter(Boolean)
